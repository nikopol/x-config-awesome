...
beautiful.init(gears.filesystem.get_configuration_dir().."themes/niko/theme.lua")
...
local separator = wibox.container.margin(
    wibox.container.place(
        wibox.widget {
            ...
            resize = false,
            image = beautiful.widget_sep
        },
        "center", 
        "center"
    ), 
    beautiful.widget_margin,
    beautiful.widget_margin,
    0,
    0
)
...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey, "Shift"   }, "x", function () awesome.spawn(LOCKER) end, 
             {description = "lock screens", group = "awesome"}),
   awful.key({                   }, "XF86PowerOff", function () awesome.spawn(LOCKER) end, 
             {description = "lock screens", group = "awesome"}),
   awful.key({                   }, "XF86Sleep", function () awesome.spawn(LOCKER) end, 
             {description = "lock screens", group = "awesome"}),
