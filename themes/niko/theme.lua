...
local theme_path = gfs.get_configuration_dir().."themes/niko/"
...
theme.fg_minimize   = theme.fg_urgent

theme.useless_gap   = dpi(0)
theme.border_width  = dpi(1)
theme.border_normal = "#000000"
theme.border_focus  = "#FF8080"
...
theme.wallpaper = theme_path.."wallpapers/archlinux2.png"
...
theme.widget_netdn  = theme_path.."icons/down.png"
...
theme.widget_sep    = theme_path.."icons/separator.png"
theme.widget_margin = 3
...
theme.vgradient        = "linear:16,0:0,0:0,"..theme.fg_end_widget..":0.5,"..theme.fg_center_widget..":1,"..theme.fg_widget
